    ...
    private final static ArrayList<Meeting> DUMMY_MEETINGS = new ArrayList<Meeting>(11) {
        {
            ...
            add(new Meeting("Reunion D", DisplayFormatter.formatStringToDate("20/05/2021"), DisplayFormatter.formatStringToTime("07:45"), DisplayFormatter.formatStringToTime("10:45"), meetingsApi.getRooms().get(3), meetingsApi.getUserEmails()));
            ...
            add(new Meeting("Reunion H", DisplayFormatter.formatStringToDate("30/04/2021"), DisplayFormatter.formatStringToTime("10:30"), DisplayFormatter.formatStringToTime("12:30"), meetingsApi.getRooms().get(2), meetingsApi.getUserEmails()));
            add(new Meeting("Reunion I", DisplayFormatter.formatStringToDate("09/04/2021"), DisplayFormatter.formatStringToTime("14:00"), DisplayFormatter.formatStringToTime("17:00"), meetingsApi.getRooms().get(5), meetingsApi.getUserEmails()));
            add(new Meeting("Reunion J", DisplayFormatter.formatStringToDate("12/07/2021"), DisplayFormatter.formatStringToTime("14:00"), DisplayFormatter.formatStringToTime("18:00"), meetingsApi.getRooms().get(9), meetingsApi.getUserEmails()));
